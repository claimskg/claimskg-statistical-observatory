...
#concat pour rassembler entites 1et2
...
df_entites_author_keywords_label_datescr = pd.merge(df_entites_author_keywords_label, df_dates_cr, on=['id1', 'id2'], how='outer')
df_entites_author_keywords_label_datescr_datescw = pd.merge(df_entites_author_keywords_label_datescr, df_dates_cw, on=['id1', 'id2'], how='outer')
df_entites_author_keywords_label_datescr_datescw_sources = pd.merge(df_entites_author_keywords_label_datescr_datescw, df_sources, on=['id1'], how='outer')
